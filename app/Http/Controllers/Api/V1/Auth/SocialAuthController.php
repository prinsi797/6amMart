    ...
    public function social_login(Request $request)
    {
        ...
        try {
            if ($request['medium'] == 'google') {
                ...
                $service_file = ($apple_login_data?->storage && $apple_login_data?->storage?->value == 's3') ? $awsBaseURL.'apple-login/'.$apple_login->service_file : 'storage/apple-login/'.$apple_login->service_file;
