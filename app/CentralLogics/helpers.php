    ...
    public static function deliverymen_list_formatting($data)
    {
        ...
        foreach ($data as $item) {
            ...
            $storage[] = [
                ...
                'image_link' => self::onerror_image_helper($item['image'], asset('storage/delivery-man/').'/'. $item['image'], asset('assets/admin/img/160x160/img1.jpg') , 'delivery-man/', $storage_type)
            ];
        }
        $data = $storage;
...
//        }
    ...
    public static function subscriptionPayment($store_id,$package_id,$payment_gateway,$url,$pending_bill=0,$type='payment',$payment_platform='web'){
        ...
        $additional_data = [
            ...
            'business_logo' => \App\CentralLogics\Helpers::get_image_helper($store_logo,'value', asset('storage/business/').'/' . $store_logo->value, asset('assets/admin/img/160x160/img2.jpg') ,'business/' )
        ];
