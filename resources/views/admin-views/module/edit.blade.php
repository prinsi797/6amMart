                                    ...
                                    <div class="row h-100">
                                        <div class="col-sm-6">
                                            <div class="form-group m-0 h-100 d-flex flex-column justify-content-center align-items-center">
                                                ...
                                                <label class="text-center my-auto position-relative">
                                                    <img class="img--176 h-unset aspect-ratio-1 image--border" id="viewer" data-onerror-image="{{asset('assets/admin/img/upload-img.png')}}" src="{{\App\CentralLogics\Helpers::get_image_helper($module,'icon', asset('storage/module/').'/'.$module['icon'], asset('assets/admin/img/upload-img.png'), 'module/') }}"
                                                    alt="image" />
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group m-0 h-100 d-flex flex-column justify-content-center align-items-center">
                                                ...
                                                <label class="text-center my-auto position-relative">
                                                    <img class="img--176 h-unset aspect-ratio-1 image--border" id="viewer2" data-onerror-image="{{asset('assets/admin/img/upload-img.png')}}" src="{{\App\CentralLogics\Helpers::get_image_helper($module,'thumbnail', asset('storage/module/').'/'.$module['thumbnail'], asset('assets/admin/img/upload-img.png'), 'module/') }}"
                                                    alt="image" />
                                                    <div class="icon-file-group">
                                                        <div class="icon-file">
...
@push('script_2')
    ...
    <script>
        ...
        $('#reset_btn').click(function(){
            ...
            $('#viewer').attr('src','{{\App\CentralLogics\Helpers::get_image_helper($module,'icon', asset('storage/module/').'/'.$module['icon'], asset('assets/admin/img/upload-img.png'), 'module/') }}');
            $('#viewer2').attr('src','{{\App\CentralLogics\Helpers::get_image_helper($module,'thumbnail', asset('storage/module/').'/'.$module['thumbnail'], asset('assets/admin/img/upload-img.png'), 'module/') }}');
        })
</script>
@endpush
