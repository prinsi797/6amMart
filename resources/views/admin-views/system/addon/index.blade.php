                    ...
                    <div class="modal-body pb-5 pt-0">
                        <div class="single-item-slider owl-carousel">
                            <div class="item">
                                <div class="mb-20">
                                    <div class="">
                                        <img src="{{asset('/admin/img/addon_setting.png')}}" loading="lazy" alt="" class="dark-support rounded mb-4 mw-100">
                                        <ol>
                ...
                <div class="card theme-card">
                    <div class="card-header">
                        ...
                        <div class="d-flex gap-2 gap-sm-3 align-items-center">
                            @if ($data['is_published'] == 0)
                                <button class="text-danger bg-transparent p-0 border-0 mr-2" data-toggle="modal" data-target="#deleteThemeModal_{{$key}}"><img src="{{asset('/admin/img/delete.svg')}}" class="svg" alt=""></button>
                                <!-- Delete Theme Modal -->
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body px-4 px-sm-5 text-center">
                                                <div class="mb-3 text-center">
                                                    <img width="75" src="{{asset('/admin/img/delete.png')}}" alt="">
                                                </div>
                            ...
                            @endif
                                ...
                                <button class="{{$data['is_published'] == 1 ? 'checkbox-color-primary' : 'text-muted'}} bg-transparent p-0 border-0" data-toggle="modal" data-target="#shiftThemeModal_{{$key}}"><img src="{{asset('/admin/img/check.svg')}}" class="svg" alt=""></button>
                                    ...
                                    <div class="modal-dialog status-warning-modal">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body px-4 pt-0 px-sm-5 text-center">
                                                <div class="mb-3 text-center">
                                                    <img width="75" src="{{asset('/admin/img/shift.png')}}" alt="">
                                                </div>
                    ...
                    <div class="p-2 p-sm-3">
                        ...
                        <div class="aspect-ration-3:2 border border-color-primary-light radius-10">
                            ...
                            data-onerror-image="{{asset('/admin/img/placeholder.png')}}"
...
@push('script_2')
<script href="{{ asset('/admin/vendor/swiper/swiper-bundle.min.js')}}"></script>
