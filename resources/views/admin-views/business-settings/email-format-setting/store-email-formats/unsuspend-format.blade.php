...
@push('css_or_js')
<link rel="stylesheet" href="{{asset('/admin/css/view-pages/email-templates.css')}}">
@endpush
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center __gap-15px">
                <h1 class="page-header-title mr-3 mb-0">
                    <span class="page-header-icon">
                        <img src="{{ asset('/admin/img/email-setting.png') }}" class="w--26" alt="">
                    </span>
                    <span>
                        ...
                        <div class="card-body">
                            <div class="email-format-wrapper">
                                ...
                                <div class="right-content">
                                    ...
                                    <div>
                                        <h5 class="card-title mb-3">
                                            <img src="{{asset('/admin/img/pointer.png')}}" class="mr-2" alt="">
...
@push('script_2')
    ...
    <script src="{{asset('/admin/js/view-pages/email-templates.js')}}"></script>
    <!-- Email Template End-->
@endpush
