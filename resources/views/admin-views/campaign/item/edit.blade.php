                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div id="image-viewer-section" class="text-center py-3 my-auto">
                                ...
                                src="{{\App\CentralLogics\Helpers::get_image_helper($campaign,'image', asset('storage/campaign/').'/'.$campaign->image, asset('/admin/img/100x100/2.png'), 'campaign/') }}" alt="campaign image" data-onerror-image="{{asset('/admin/img/100x100/2.png')}}"/>
                            </div>
