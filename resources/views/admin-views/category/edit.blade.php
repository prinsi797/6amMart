                        ...
                        <div class="col-md-6">
                            ...
                            <div class="h-100 d-flex align-items-center flex-column">
                                ...
                                <label class="text-center my-auto position-relative d-inline-block">
                                    ...
                                    src="{{\App\CentralLogics\Helpers::get_image_helper($category,'image', asset('storage/category/').'/'.$category['image'], asset('/admin/img/upload-img.png'), 'category/') }}"
...
@push('script_2')
    <script src="{{asset('/admin')}}/js/view-pages/category-index.js"></script>
    <script>
        "use strict";
        $('#reset_btn').click(function(){
            $('#module_id').val("{{ $category->module_id }}").trigger('change');
            $('#viewer').attr('src', "{{\App\CentralLogics\Helpers::get_image_helper($category,'image', asset('storage/category/').'/'.$category['image'], asset('assets/admin/img/upload-img.png'), 'category/') }}");
        })
