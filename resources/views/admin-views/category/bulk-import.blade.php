            ...
            <div class="card-body">
                ...
                <div class="text-center pb-4">
                    ...
                    <div class="btn--container justify-content-center export--template-btns">
                        ...
                        <a href="{{asset('/categories_bulk_format.xlsx')}}" download="" class="btn btn--primary btn-outline-primary">{{ translate('Template with Existing Data') }}</a>
                        <a href="{{asset('/categories_bulk_without_data_format.xlsx')}}" download="" class="btn btn--primary">{{ translate('Template without Data') }}</a>
...
@push('script_2')
    <script src="{{asset('/admin')}}/js/view-pages/category-import-export.js"></script>
<script>
    "use strict";
