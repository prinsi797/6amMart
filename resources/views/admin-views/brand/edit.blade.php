                            ...
                            <div class="h-100 d-flex align-items-center flex-column">
                                ...
                                <label class="text-center my-auto position-relative d-inline-block">
                                    <img class="img--176 border" id="viewer"
                                         src="{{\App\CentralLogics\Helpers::get_image_helper($brand,'image', asset('storage/brand/').'/'.$brand['image'], asset('assets/admin/img/upload-img.png'), 'brand/') }}"
...
@push('script_2')
    ...
    <script>
        ...
        $('#reset_btn').click(function(){
            ...
            $('#viewer').attr('src', "{{asset('storage/brand')}}/{{$brand['image']}}");
        })
    </script>
@endpush
