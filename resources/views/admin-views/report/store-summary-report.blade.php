...
<div class="content container-fluid">
    ...
    <div class="page-header report-page-header">
        <div class="d-flex">
            <img src="{{asset('/admin/img/store-report.svg')}}" class="page-header-icon" alt="">
...
@push('script_2')
    ...
    <script src="{{asset('/admin')}}/vendor/chart.js.extensions/chartjs-extensions.js"></script>
    <script src="{{asset('/admin')}}/vendor/chartjs-plugin-datalabels/dist/chartjs-plugin-datalabels.min.js"></script>
