        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{asset('/admin/img/report.png')}}" class="w--22" alt="">
                </span>
                <span>
                            ...
                            <td>
                                <a class="media align-items-center" href="{{route('admin.item.view',[$item['id'],'module_id'=>$item['module_id']])}}">
                                    ...
                                    src="{{ \App\CentralLogics\Helpers::get_image_helper(
                                        ...
                                        asset('/admin/img/160x160/img2.jpg'),
                                        'product/'
                                    ) }}"


                                    data-onerror-image="{{asset('/admin/img/160x160/img2.jpg')}}" alt="{{$item->name}} image">
...
@push('script_2')
    ...
    <script
        src="{{asset('/admin')}}/vendor/chartjs-chart-matrix/dist/chartjs-chart-matrix.min.js"></script>
    <script src="{{asset('/admin')}}/js/hs.chartjs-matrix.js"></script>
    <script src="{{ asset('/admin') }}/js/view-pages/admin-reports.js"></script>
    <script>
        "use strict";
