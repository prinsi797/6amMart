            ...
            <div class="card-body">
                ...
                <div class="text-center pb-4">
                    ...
                    <div class="btn--container justify-content-center export--template-btns">
                        @if($module_type== 'food')
                        <a href="{{asset('/foods_bulk_format.xlsx')}}" download="" class="btn btn--primary btn-outline-primary">{{translate('With Current Data')}}</a>
                        @else
                        <a href="{{asset('/items_bulk_format.xlsx')}}" download="" class="btn btn--primary btn-outline-primary">{{translate('With Current Data')}}</a>
                            @endif
                        <a href="{{asset('/items_bulk_format_nodata.xlsx')}}" download="" class="btn btn--primary">{{translate('Without Any Data')}}</a>
                    </div>
                </div>
            </div>
        </div>
...
@push('script_2')
    ...
    <script src="{{asset('/admin')}}/js/view-pages/product-import.js"></script>
<script>
    "use strict";
