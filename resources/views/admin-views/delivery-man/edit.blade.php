                        ...
                        <div class="col-lg-4">
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="text-center py-3 my-auto">
                                    ...
                                    src="{{\App\CentralLogics\Helpers::get_image_helper($deliveryMan,'image', asset('storage/delivery-man/').'/'.$deliveryMan['image'], asset('assets/admin/img/admin.png'), 'delivery-man/') }}"
                                ...
                                <div class="col-md-6 pb-0">
                                    <div class="row g-2">
                                        ...
                                        <div class="col-6 spartan_item_wrapper size--sm">
                                            <img class="rounded border" src="{{\App\CentralLogics\Helpers::onerror_image_helper($img['img'], asset('storage/delivery-man/').'/'.$img['img'], asset('assets/admin/img/160x160/img1.jpg'), 'delivery-man/',$img['storage'] ?? 'public') }}">
                                        </div>
                                        @endforeach
                                    </div>
                                </div>
