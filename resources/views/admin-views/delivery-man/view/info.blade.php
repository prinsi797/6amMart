                ...
                <div class="d-flex flex-column flex-md-row align-items-center gap-3 border rounded p-3">
                    <div class="d-flex gap-3">
                        <img class="rounded" data-onerror-image="{{ asset('assets/admin/img/160x160/img1.jpg') }}"
                            src="{{ \App\CentralLogics\Helpers::get_image_helper($deliveryMan,'image', asset('storage/delivery-man/') . '/' . $deliveryMan['image'], asset('assets/admin/img/160x160/img1.jpg'), 'delivery-man/') }}"
                                ...
                                <button class="btn" data-toggle="modal" data-target="#image-{{ $key }}">
                                    <div class="gallary-card">
                                        <img class="rounded mx-h150 mx-w-100"
                                            ...
                                            src="{{ \App\CentralLogics\Helpers::onerror_image_helper($img['img'], asset('storage/delivery-man/') . '/' . $img['img'], asset('assets/admin/img/900x400/img1.jpg'), 'delivery-man/',$img['storage'] ?? 'public') }}"
