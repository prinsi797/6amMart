                                        ...
                                        <span class="d-block font-size-sm text-body">
                                            <a href="{{route('admin.users.delivery-man.preview',[$review['delivery_man_id']])}}"
                                               class="media gap-2 align-items-center text-dark">
                                                <img  src="{{Helpers::get_image_helper($review->delivery_man,'image', asset('storage/delivery-man/').'/'.$review->delivery_man->image, asset('assets/admin/img/160x160/img1.jpg'), 'delivery-man/') }}"
                                    ...
                                    <td>
                                        <div class="btn--container justify-content-center">
                                            <a class="btn action-btn btn--warning btn-outline-warning view-details" href="#"
                                               ...
                                               data-image="{{Helpers::get_image_helper($review->delivery_man,'image', asset('storage/delivery-man/').'/'.$review->delivery_man->image, asset('assets/admin/img/160x160/img1.jpg'), 'delivery-man/') }}"
