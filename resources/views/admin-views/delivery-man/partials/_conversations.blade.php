    ...
    <div class="card-header">
        <div class="chat-user-info w-100 d-flex align-items-center">
            <div class="chat-user-info-img">
                ...
                src="{{\App\CentralLogics\Helpers::get_image_helper($user,'image', asset('storage/profile/').'/'.$user['image'], asset('/admin/img/160x160/img1.jpg'), 'profile/') }}"
                    data-onerror-image="{{asset('/admin')}}/img/160x160/img1.jpg"
                ...
                @if($con->sender_id == $user->id)
                    <div class="py-2 d-flex gap-2 align-items-end">
                        <div class="chat-user-conv-img">
                            <img class="avatar-img onerror-image" width="28" height="28" src="{{\App\CentralLogics\Helpers::get_image_helper($user,'image', asset('storage/profile/').'/'.$user['image'], asset('/admin/img/160x160/img1.jpg'), 'profile/') }}" data-onerror-image="{{ asset('/admin/img/160x160/img1.jpg') }}" alt="Image Description">
                        </div>
                            ...
                            <br>
                                <img class="w-100 mb-3"
                                     src="{{ \App\CentralLogics\Helpers::onerror_image_helper(
                                        $img['img'],
                                        asset('storage/conversation').'/'.$img['img'],
                            ...
                            <br>
                                <img class="w-100 mb-3"
                                     src="{{ \App\CentralLogics\Helpers::onerror_image_helper(
                                        $img['img'],
                                        asset('storage/conversation').'/'.$img['img'],
                                        asset('/admin/img/160x160/img1.jpg'),
                                        'conversation/',$img['storage']
                                    ) }}">
                                @endforeach
                            @endif
        ...
        <div class="text-danger d-inline-block learn-more-wrap cursor-pointer">
            ...
            <div class="learn-more-content p-4">
                <div class="d-flex align-items-center gap-2 mb-3">
                    <img class="rounded-circle" width="20" height="20" src="{{asset('/admin/img/icons/info-icon.png')}}" alt="">
