                            ...
                            <div class="text-right mt-3 order-invoice-right-contents text-capitalize">
                                ...
                                @if ($order->order_attachment)
                                                ...
                                                <div>
                                                    <button class="btn w-100 px-0" data-toggle="modal"
                                                        ...
                                                        <div class="gallary-card ml-auto">
                                                            <img  src="{{\App\CentralLogics\Helpers::onerror_image_helper($item['img'], asset('storage/order').'/'.$item['img'], asset('assets/admin/img/160x160/img2.jpg'), 'order/', $item['storage']??'public') }}"
                                    ...
                                    <button class="btn w-100 px-0" data-toggle="modal" data-target="#imagemodal"
                                        ...
                                        <div class="gallary-card ml-auto">
                                            <img
                                            src="{{\App\CentralLogics\Helpers::get_image_helper($order,'order_attachment', asset('storage/app/public/order').'/'.$order->order_attachment, asset('assets/admin/img/160x160/img2.jpg'), 'order/') }}"
                                    ...
                                    <div class="modal fade" id="imagemodal" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <img src="{{\App\CentralLogics\Helpers::get_image_helper($order,'order_attachment', asset('storage/app/public/order').'/'.$order->order_attachment, asset('assets/admin/img/160x160/img2.jpg'), 'order/') }}"
                                                        class="initial--22 w-100">
                                                </div>
                            ...
                            <div class="mx-3">
                                <div class="media align-items-center cart--media pb-2">
                                    <div class="avatar avatar-xl mr-3"
                                        ...
                                        src="{{\App\CentralLogics\Helpers::get_image_helper($order->parcel_category,'image', asset('storage/parcel_category').'/'.($order->parcel_category ? $order->parcel_category->image : ''), asset('assets/admin/img/160x160/img2.jpg'), 'parcel_category/') }}"
                                                        ...
                                                        <div class="media media--sm">
                                                            @if ($editing)
                                                                <div class="avatar avatar-xl mr-3 cursor-pointer quick-view-cart-item" data-key="{{ $key }}"
                                                                    ...
                                                                    src="{{\App\CentralLogics\Helpers::get_image_helper($product,'image', asset('storage/product/').'/'. $product->image, asset('assets/admin/img/100x100/2.png') , 'product/') }}"
                                                            ...
                                                            @if ($editing)
                                                                <div class="avatar avatar-xl mr-3  cursor-pointer quick-view-cart-item" data-key="{{ $key }}"
                                                                    ...
                                                                    <img class="img-fluid rounded onerror-image"
                                                                        src="{{\App\CentralLogics\Helpers::get_image_helper($campaign,'image', asset('storage/campaign/').'/'. $campaign['image'], asset('assets/admin/img/160x160/img2.jpg') , 'campaign/') }}"
                                                                        data-onerror-image="{{ asset('assets/admin/img/160x160/img2.jpg') }}"
                                                                        alt="Image Description">
                                                                </div>
                                                            @else
                                        ...
                                        @php($img = is_array($img)?$img:['img'=>$img,'storage'=>'public'])
                                            <div class="col-3">
                                                <img class="img__aspect-1 rounded border w-100 onerror-image" data-toggle="modal"
                                                    data-target="#imagemodal{{ $key }}"
                                                    data-onerror-image="{{ asset('assets/admin/img/160x160/img2.jpg') }}"
                                                    src="{{\App\CentralLogics\Helpers::onerror_image_helper($img['img'], asset('storage/refund/').'/'. $img['img'], asset('assets/admin/img/160x160/img2.jpg') , 'refund/',$img['storage'] ?? 'public') }}">
                                            </div>
                                            <div class="modal fade" id="imagemodal{{ $key }}" tabindex="-1"
                                ...
                                <a class="media align-items-center deco-none customer--information-single"
                                    ...
                                    <div class="avatar avatar-circle">
                                        <img class="avatar-img onerror-image"
                                            ...
                                            src="{{ \App\CentralLogics\Helpers::get_image_helper($order->delivery_man,'image', asset('storage/delivery-man/').'/'. $order->delivery_man->image, asset('assets/admin/img/160x160/img1.jpg') , 'delivery-man/') }}"
                                            alt="Image Description">
                                    </div>
                                    <div class="media-body">
                                        <span
                        ...
                        @if ($order->customer && $order->is_guest == 0)
                            ...
                            <a class="media align-items-center deco-none customer--information-single"
                                ...
                                <div class="avatar avatar-circle">
                                    <img class="avatar-img onerror-image"
                                        data-onerror-image="{{ asset('assets/admin/img/160x160/img1.jpg') }}"
                                        src="{{ \App\CentralLogics\Helpers::get_image_helper($order->customer,'image', asset('storage/profile/').'/'. $order->customer->image, asset('assets/admin/img/160x160/img1.jpg') , 'profile/') }}"
                                        alt="Image Description">
                                </div>
                                <div class="media-body">
                                ...
                                @php($img = is_array($img)?$img:['img'=>$img,'storage'=>'public'])
                                    <div class="col-3">
                                        <img class="img__aspect-1 rounded border w-100 onerror-image" data-toggle="modal"
                                            data-target="#imagemodal{{ $key }}"
                                            data-onerror-image="{{ asset('assets/admin/img/160x160/img2.jpg') }}"
                                            src="{{\App\CentralLogics\Helpers::onerror_image_helper($img['img'] , asset('storage/order/') .'/'. $img['img'] , asset('assets/admin/img/160x160/img2.jpg'), 'order/',$img['storage'] ?? 'public') }}">
                                    </div>
                                    <div class="modal fade" id="imagemodal{{ $key }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <img src="{{\App\CentralLogics\Helpers::onerror_image_helper($img['img'] , asset('storage/order/') .'/'. $img['img'] , asset('assets/admin/img/160x160/img2.jpg'), 'order/',$img['storage'] ?? 'public') }}"
                                                        class="initial--22 w-100">
                                                </div>
                                                @php($storage = $img['storage'] ?? 'public')
                            ...
                            <a class="media align-items-center deco-none resturant--information-single"
                                ...
                                <div class="avatar avatar-circle">
                                    <img class="avatar-img w-75px onerror-image"
                                        ...
                                        src="{{\App\CentralLogics\Helpers::get_image_helper($order?->store,'logo' , asset('storage/store/') .'/'. $order?->store?->logo , asset('assets/admin/img/100x100/1.png'), 'store/') }}"
                                        alt="Image Description">
                                </div>
                                <div class="media-body">
                                    <span class="fz--14px text--title font-semibold text-hover-primary d-block">
                                        ...
                                        @php($photo = is_array($photo)?$photo:['img'=>$photo,'storage'=>'public'])
                                            <div class="spartan_item_wrapper min-w-176px max-w-176px">
                                                <img class="img--square"
                                                     src="{{\App\CentralLogics\Helpers::onerror_image_helper($photo['img'] , asset('storage/order/') .'/'. $photo['img'] , asset('assets/admin/img/160x160/img2.jpg'), 'order/',$photo['storage'] ?? 'public') }}"
                                                    alt="order image">
                                    ...
                                    <li class="list-group-item">
                                        <span class="dm_list" role='button' data-id="{{ $dm['id'] }}">
                                            <img class="avatar avatar-sm avatar-circle mr-1 onerror-image"
                                                data-onerror-image="{{ asset('assets/admin/img/160x160/img1.jpg') }}"
                                                src="{{\App\CentralLogics\Helpers::onerror_image_helper($dm['image'], asset('storage/delivery-man/') .'/'. $dm['image'], asset('assets/admin/img/160x160/img1.jpg'), 'delivery-man/',$dm['storage']??'public') }}"
                                                alt="{{ $dm['name'] }}">
                                            {{ $dm['name'] }}
                                        </span>
                    ...
                    return function() {
                        @if ($parcel_order)
                            infowindow.setContent(
                                "<div style='float:left'><img style='max-height:40px;wide:auto;' src='{{\App\CentralLogics\Helpers::get_image_helper($order?->customer,'image', asset('storage/profile/').'/'. $order?->customer?->image, asset('assets/admin/img/160x160/img1.jpg') , 'profile/') }}'></div><div style='float:right; padding: 10px;'><b>{{ $order->customer->f_name }}{{ $order->customer->l_name }}</b><br />{{ $address['address'] }}</div>"
                            );
                        @else
                            infowindow.setContent(
                                "<div style='float:left'><img style='max-height:40px;wide:auto;' src='{{\App\CentralLogics\Helpers::get_image_helper($order?->store,'logo', asset('storage/restaurant/').'/'. $order?->store?->logo, asset('assets/admin/img/160x160/img1.jpg') , 'restaurant/') }}'></div><div class='text-break' style='float:right; padding: 10px;'><b>{{ Str::limit($order?->store?->name, 15, '...') }}</b><br /> {{ $order->store->address }}</div>"
                            );
                        @endif
            ...
            function initializegLocationMap() {
                ...
                @if ($order->delivery_man && $order->dm_last_location)
                    ...
                    google.maps.event.addListener(dmmarker, 'click', (function(dmmarker) {
                        return function() {
                            infowindow.setContent(
                                "<div style='float:left'><img style='max-height:40px;wide:auto;' src='{{\App\CentralLogics\Helpers::get_image_helper($order?->delivery_man,'image', asset('storage/delivery-man/').'/'. $order?->delivery_man?->image, asset('assets/admin/img/160x160/img1.jpg') , 'delivery-man/') }}'></div> <div style='float:right; padding: 10px;'><b>{{ $order->delivery_man->f_name }} {{ $order->delivery_man->l_name }}</b><br /> {{ $order->dm_last_location['location'] }}</div>"
                            );
                ...
                @if ($order->store)
                    ...
                    google.maps.event.addListener(Retaurantmarker, 'click', (function(Retaurantmarker) {
                        return function() {
                            infowindow.setContent(
                                "<div style='float:left'><img style='max-height:40px;wide:auto;' src='{{\App\CentralLogics\Helpers::get_image_helper($order?->store,'logo' , asset('storage/store/') .'/'. $order?->store?->logo , asset('assets/admin/img/100x100/1.png'), 'store/') }}'></div> <div style='float:right; padding: 10px;'><b>{{ Str::limit($order?->store?->name, 15, '...') }}</b><br /> {{ $order->store->address }}</div>"
                            );
