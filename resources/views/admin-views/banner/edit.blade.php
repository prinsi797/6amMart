                                ...
                                <div class="col-lg-6">
                                    <div class="h-100 d-flex flex-column">
                                        ...
                                        <div class="text-center py-3 my-auto">
                                            <img class="img--vertical onerror-image" id="viewer" data-onerror-image="{{asset('assets/admin/img/900x400/img1.jpg')}}" src="{{\App\CentralLogics\Helpers::get_image_helper($banner,'image', asset('storage/banner/').'/'.$banner['image'], asset('assets/admin/img/900x400/img1.jpg'), 'banner/') }}"
                                            alt="banner image"/>
                                        </div>
