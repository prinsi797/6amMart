                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="media align-items-center" href="{{route('admin.item.view',[$item['item_id']])}}">
                                            <img class="avatar avatar-lg mr-3 onerror-image" src="{{\App\CentralLogics\Helpers::get_image_helper($item->item,'image', asset('storage/product/').'/'.$item->item['image'], asset('/admin/img/160x160/img2.jpg'), 'product/') }}"
                                            data-onerror-image="{{asset('/admin/img/160x160/img2.jpg')}}" alt="{{$item->item->name}} image">
