<div class="col-sm-6 col-lg-3">
    ...
    <a class="resturant-card dashboard--card card--bg-1" href="{{route('vendor.order.list',['confirmed'])}}">
       ...
       <img src="{{asset('/admin/img/dashboard/1.png')}}" alt="img" class="resturant-icon">
    </a>
    <!-- End Card -->
</div>
...
<div class="col-sm-6 col-lg-3">
    ...
    <a class="resturant-card dashboard--card card--bg-2" href="{{route('vendor.order.list',['cooking'])}}">
       ...
       <span class="subtitle">{{translate('messages.processing')}}</span>
        @endif
       <img src="{{asset('/admin/img/dashboard/2.png')}}" alt="img" class="resturant-icon">
    </a>
    <!-- End Card -->
</div>
...
<div class="col-sm-6 col-lg-3">
    ...
    <a class="resturant-card dashboard--card card--bg-3" href="{{route('vendor.order.list',['ready_for_delivery'])}}">
       ...
       <img src="{{asset('/admin/img/dashboard/3.png')}}" alt="img" class="resturant-icon">
    </a>
    <!-- End Card -->
</div>
...
<div class="col-sm-6 col-lg-3">
    ...
    <a class="resturant-card dashboard--card card--bg-4" href="{{route('vendor.order.list',['item_on_the_way'])}}">
       ...
       <img src="{{asset('/admin/img/dashboard/4.png')}}" alt="img" class="resturant-icon">
    </a>
    <!-- End Card -->
</div>
