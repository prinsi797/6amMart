        ...
        <div class="col-md-4 col-6">
            <div class="grid-card top--rated-food pb-4 cursor-pointer redirect-url"
                ...
                <div class="text-center">
                    <img class="rounded onerror-image" src="{{\App\CentralLogics\Helpers::get_image_helper($item,'image', asset('storage/product').'/'.$item['image'], asset('assets/admin/img/100x100/2.png'), 'product/') }}"
