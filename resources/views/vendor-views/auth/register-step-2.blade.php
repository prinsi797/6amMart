...
@push('css_or_js')
    ...
    <link rel="stylesheet" href="{{ asset('/admin/css/view-pages/vendor-registration.css') }}">
    <link rel="stylesheet" href="{{ asset('/landing/css/select2.min.css') }}"/>
@endpush
@section('content')
                            ...
                            <div class="plan-slider owl-theme owl-carousel owl-refresh">
                                ...
                                <label class="__plan-item {{ count($packages) > 4 &&  $key == 2 ||( count($packages) < 5 &&  $key == 1) ? 'active' : '' }} ">
                                    ...
                                    <div class="inner-div">
                                        ...
                                        @if ($package->pos)
                                        <li>
                                            <img src="{{asset('//landing/img/check-1.svg')}}" class="check" alt="">
                                                <img src="{{asset('//landing/img/check-2.svg')}}" class="check-white" alt=""> <span>  {{ translate('messages.POS') }} </span>
                                        </li>
                                        @endif
                                        @if ($package->mobile_app)
                                        <li>
                                            <img src="{{asset('//landing/img/check-1.svg')}}" class="check" alt="">
                                                <img src="{{asset('//landing/img/check-2.svg')}}" class="check-white" alt=""> <span>  {{ translate('messages.mobile_app') }} </span>
                                        </li>
                                        @endif
                                        @if ($package->chat)
                                        <li>
                                            <img src="{{asset('//landing/img/check-1.svg')}}" class="check" alt="">
                                                <img src="{{asset('//landing/img/check-2.svg')}}" class="check-white" alt=""> <span>  {{ translate('messages.chatting_options') }} </span>
                                        </li>
                                        @endif
                                        @if ($package->review)
                                        <li>
                                            <img src="{{asset('//landing/img/check-1.svg')}}" class="check" alt="">
                                                <img src="{{asset('//landing/img/check-2.svg')}}" class="check-white" alt=""> <span>  {{ translate('messages.review_section') }} </span>
                                        </li>
                                        @endif
                                        @if ($package->self_delivery)
                                        <li>
                                            <img src="{{asset('//landing/img/check-1.svg')}}" class="check" alt="">
                                                <img src="{{asset('//landing/img/check-2.svg')}}" class="check-white" alt=""> <span>  {{ translate('messages.self_delivery') }} </span>
                                        </li>
                                        @endif
                                        @if ($package->max_order == 'unlimited')
                                        <li>
                                            <img src="{{asset('//landing/img/check-1.svg')}}" class="check" alt="">
                                                <img src="{{asset('//landing/img/check-2.svg')}}" class="check-white" alt=""> <span>  {{ translate('messages.Unlimited_Orders') }} </span>
                                        </li>
                                        @else
                                        <li>
                                            <img src="{{asset('//landing/img/check-1.svg')}}" class="check" alt="">
                                                <img src="{{asset('//landing/img/check-2.svg')}}" class="check-white" alt=""> <span>  {{ $package->max_order }} {{ translate('messages.Orders') }} </span>
                                        </li>
                                        @endif
                                        @if ($package->max_product == 'unlimited')
                                        <li>
                                            <img src="{{asset('//landing/img/check-1.svg')}}" class="check" alt="">
                                                <img src="{{asset('//landing/img/check-2.svg')}}" class="check-white" alt=""> <span>  {{ translate('messages.Unlimited_uploads') }} </span>
                                        </li>
                                        @else
                                        <li>
                                            <img src="{{asset('//landing/img/check-1.svg')}}" class="check" alt="">
                                                <img src="{{asset('//landing/img/check-2.svg')}}" class="check-white" alt=""> <span>  {{ $package->max_product }} {{ translate('messages.uploads') }} </span>
                                        </li>
                                        @endif
                                        </ul>
                                    </div>
