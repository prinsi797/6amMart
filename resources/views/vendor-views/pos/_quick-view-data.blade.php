...
<div class="modal-body">
    <div class="d-flex flex-row align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-center active">
            ...
            src="{{\App\CentralLogics\Helpers::get_image_helper($product,'image', asset('storage/app/').'/'.$product['image'], asset('/admin/img/160x160/img2.jpg'), 'product/') }}"
                 data-onerror-image="{{ asset('/admin/img/160x160/img2.jpg') }}"
                data-zoom="{{ asset('storage/app/') }}/{{ $product['image'] }}" alt="Product image"
                width="">
...
<script src="{{asset('/admin')}}/js/view-pages/common.js"></script>
