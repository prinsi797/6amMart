...
<div class="modal-body">
    <div class="d-flex flex-row align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-center active h-9rem">
            <img class="img-responsive img-responsive-1 onerror-image" src="{{\App\CentralLogics\Helpers::get_image_helper($product,'image', asset('storage/product/').'/'.$product['image'], asset('assets/admin/img/160x160/img2.jpg'), 'product/') }}"
