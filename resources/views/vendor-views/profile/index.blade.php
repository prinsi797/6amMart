                    ...
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        ...
                        <label
                            ...
                            <img id="viewer"
                                 ...
                                 src="{{\App\CentralLogics\Helpers::get_image_helper(auth('vendor')->check() ? auth('vendor')->user() : auth('vendor_employee')->user(),'image', asset('storage/vendor/').'/'.(auth('vendor')->check() ? auth('vendor')->user()->image : auth('vendor_employee')->user()->image), asset('assets/admin/img/160x160/img1.jpg'), 'vendor/') }}"
                                 alt="Image">
