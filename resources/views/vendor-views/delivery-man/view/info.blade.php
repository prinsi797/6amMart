                    ...
                    <div class="col-md-6">
                        <div class="d-flex align-items-center justify-content-center">
                            <img class="avatar avatar-xxl avatar-4by3 mr-4 img--120 onerror-image"
                                 ...
                                 src="{{\App\CentralLogics\Helpers::get_image_helper($dm,'image', asset('storage/delivery-man').'/'.$dm['image'], asset('assets/admin/img/160x160/img1.jpg'), 'delivery-man/') }}"
                        ...
                        <tr>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="avatar avatar-circle">
                                            <img class="avatar-img onerror-image" width="75" height="75"
                                                 data-onerror-image="{{asset('assets/admin/img/160x160/img1.jpg')}}"
                                                 src="{{\App\CentralLogics\Helpers::get_image_helper($review->customer,'image', asset('storage/profile/').'/'.$review->customer->image, asset('assets/admin/img/160x160/img1.jpg'), 'profile/') }}"
                                                alt="Image Description">
                                        </div>
                                        <div class="ml-3">
                            ...
                            <td>
                                ...
                                @php($attachment = is_array($attachment)?$attachment:['img'=>$attachment,'storage'=>'public'])
                                    <img width="100" class="onerror-image" data-onerror-image="{{asset('assets/admin/img/160x160/img2.jpg')}}"  src="{{\App\CentralLogics\Helpers::onerror_image_helper($attachment['img'], asset('storage/app/public').'/'.$attachment['img'], asset('assets/admin/img/160x160/img2.jpg'), $attachment['img'].'/',$attachment['storage'] ?? 'public') }}"
                                    alt="image">
                                @endforeach
                            </td>
                            <td>
