                        ...
                        <tr>
                            ...
                            <td>
                                <div class="overflow-hidden">
                                    <img class="img--vertical max--200 mw--200 onerror-image" src="{{\App\CentralLogics\Helpers::get_image_helper($campaign,'image', asset('storage/campaign').'/'.$campaign['image'], asset('/admin/img/160x160/img2.jpg'), 'campaign/') }}"
                                         data-onerror-image="{{asset('/admin/img/160x160/img2.jpg')}}"  alt="image">
                                </div>
                            </td>
                            <td>
