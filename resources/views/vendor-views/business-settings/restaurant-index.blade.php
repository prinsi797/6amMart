        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{asset('/admin/img/config.png')}}" class="w--30" alt="">
                </span>
                <span>
                        ...
                        <div class="form-group m-0">
                            <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border rounded px-3 form-control" for="free_delivery">
                                <span class="pr-2">
                                    ...
                                    <span data-toggle="tooltip" data-placement="right" data-original-title="{{translate('If this option is on, customers will get free delivery')}}" class="input-label-secondary"><img src="{{asset('/admin/img/info-circle.svg')}}" alt="i"></span>
                                </span>
                            ...
                            <div class="form-group mb-0">
                                ...
                                <span class="pr-2 d-flex">
                                    ...
                                    <span data-toggle="tooltip" data-placement="right"
                                        ...
                                        <img src="{{asset('/admin/img/info-circle.svg')}}" alt="i">
                                    </span>
                                </span>
                                    <input type="checkbox"
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mb-0 p-2">
                                <label class="d-flex justify-content-between switch toggle-switch-sm text-dark" for="gst_status">
                                    ...
                                    data-original-title="{{translate('messages.gst_status')}}"><img src="{{asset('assets/admin/img/info-circle.svg')}}" alt="{{translate('messages.gst_status')}}"></span></span>
                                        ...
                                        <label class="__custom-upload-img mr-lg-5">
                                            ...
                                            <div class="text-center">
                                                <img class="img--110 min-height-170px min-width-170px onerror-image" id="viewer"
                                                     data-onerror-image="{{ asset('/admin/img/upload.png') }}"
                                                     src="{{\App\CentralLogics\Helpers::get_image_helper($store,'meta_image', asset('storage/store').'/'.$store->meta_image, asset('/admin/img/upload.png'), 'store/') }}"
