...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="disbursement-report mb-20">
            ...
            <div class="__card-3 rebursement-item">
                <img src="{{asset('/admin/img/report/new/trx5.png')}}" class="icon" alt="report/new">
                ...
                <div class="info-icon" data-toggle="tooltip" data-placement="top" data-original-title="When the order is successfully delivered full order amount goes to this section.">
                    <img src="{{asset('/admin/img/report/new/info5.png')}}" alt="report/new">
                </div>
            </div>

            <div class="__card-3 rebursement-item">
                <img src="{{asset('/admin/img/report/new/trx3.png')}}" class="icon" alt="report/new">
                ...
                <div class="info-icon" data-toggle="tooltip" data-placement="top" data-original-title="When the order is successfully delivered full order amount goes to this section.">
                    <img src="{{asset('/admin/img/report/new/info3.png')}}" alt="report/new">
                </div>
            </div>
        </div>
...
@push('script_2')
    <script src="{{asset('/admin')}}/js/view-pages/vendor/report.js"></script>
@endpush
