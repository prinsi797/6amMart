                    ...
                    <div class="card">
                        ...
                        <div class="card-body d-flex flex-column pt-0">
                            <div class="text-center my-auto py-4 py-xl-5">
                                ...
                                data-onerror-image="{{asset('/admin/img/image-place-holder.png')}}"
                                src="{{\App\CentralLogics\Helpers::get_image_helper($shop,'logo', asset('storage/store/').'/'.$shop->logo, asset('/admin/img/image-place-holder.png'), 'store/') }}" alt="Product thumbnail"/>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body d-flex flex-column pt-0">
                            <div class="text-center my-auto py-4 py-xl-5">
                                ...
                                data-onerror-image="{{asset('/admin/img/restaurant_cover.jpg')}}"
                                src="{{\App\CentralLogics\Helpers::get_image_helper($shop,'cover_photo', asset('storage/store/cover/').'/'.$shop->cover_photo, asset('/admin/img/restaurant_cover.jpg'), 'store/cover/') }}" alt="Product thumbnail"/>
                            </div>
                            <div class="custom-file">
...
@push('script_2')
    <script src="{{asset('/admin')}}/js/view-pages/vendor/shop-edit.js"></script>
@endpush
