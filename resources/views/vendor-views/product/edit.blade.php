...
@push('css_or_js')
    ...
    <link href="{{asset('/admin/css/tags-input.min.css')}}" rel="stylesheet">
@endpush
                        ...
                        <div class="card-body d-flex flex-column">
                                ...
                                <div class="row" id="coba">
                                    ...
                                    @php($photo = is_array($photo)?$photo:['img'=>$photo,'storage'=>'public'])
                                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6 spartan_item_wrapper" id="product_images_{{ $key }}">
                                            <img class="img--square onerror-image" src="{{\App\CentralLogics\Helpers::onerror_image_helper($photo['img'], asset('storage/product/').'/'.$photo['img'], asset('/admin/img/400x400/img2.jpg'), 'product/',$photo['storage'] ?? 'public') }}"
                            ...
                            <div class="mt-3">
                                ...
                                <div class="text-center d-block" id="image-viewer-section" class="pt-2">
                                    ...
                                    src="{{\App\CentralLogics\Helpers::get_image_helper($product,'image', asset('storage/product/').'/'.$product['image'], asset('/admin/img/400x400/img2.jpg'), 'product/') }}"
...
@push('script_2')
    <script src="{{asset('/admin')}}/js/tags-input.min.js"></script>
    <script src="{{asset('/admin/js/spartan-multi-image-picker.js')}}"></script>
    <script src="{{asset('/admin')}}/js/view-pages/vendor/product-index.js"></script>
    <script>
        "use strict";
    ...
    function add_more_customer_choice_option(i, name) {
        ...
        $(function () {
            $("#coba").spartanMultiImagePicker({
                ...
                maxFileSize: '',
                placeholderImage: {
                    image: "{{asset('/admin/img/400x400/img2.jpg')}}",
                    width: '100%'
                },
