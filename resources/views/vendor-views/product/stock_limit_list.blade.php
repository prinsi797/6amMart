                        ...
                        <tr>
                            ...
                            <td>
                                <a class="media align-items-center" href="{{route('vendor.item.view',[$item['id']])}}">
                                    <img class="avatar avatar-lg mr-3 onerror-image" src="{{\App\CentralLogics\Helpers::get_image_helper($item,'image', asset('storage/product/').'/'.$item['image'], asset('/admin/img/160x160/img2.jpg'), 'product/') }}"
        ...
        $(document).on('ready', function () {
          ...
          language: {
            zeroRecords: '<div class="text-center p-4">' +
                '<img class="w-7rem mb-3" src="{{asset('/admin/svg/illustrations/sorry.svg')}}" alt="Image Description">' +
