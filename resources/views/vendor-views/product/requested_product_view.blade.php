            ...
            <div class="d-flex flex-wrap justify-content-between">
                <h1 class="page-header-title text-break">
                    <span class="page-header-icon">
                        <img src="{{ asset('/admin/img/temp_pro.png') }}" class="w--22" alt="">
                    </span>
                ...
                <div class="row flex-wrap">
                    <div>
                        <div class="d-flex flex-wrap align-items-center food--media position-relative mr-4">
                            ...
                            src="{{\App\CentralLogics\Helpers::get_image_helper($product,'image', asset('storage/product/').'/'.$product['image'], asset('/admin/img/160x160/img2.jpg'), 'product/') }}"
