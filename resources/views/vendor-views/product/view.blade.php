                    ...
                    <div class="row align-items-md-center">
                        <div class="col-lg-5 col-md-6 mb-3 mb-md-0">
                            <div class="d-flex flex-wrap align-items-center food--media">
                                ...
                                src="{{\App\CentralLogics\Helpers::get_image_helper($product,'image', asset('storage/product/').'/'.$product['image'], asset('assets/admin/img/160x160/img2.jpg'), 'product/') }}"
                                        ...
                                        <div class="position-relative media align-items-center">
                                            <a class=" text-hover-primary absolute--link" href="{{route('vendor.item.view',[$review->item['id']])}}">
                                                <img class="avatar avatar-lg mr-3  onerror-image"  data-onerror-image="{{asset('assets/admin/img/160x160/img1.jpg')}}"
                                                     src="{{\App\CentralLogics\Helpers::get_image_helper($review->item,'image', asset('storage/product/').'/'.$review->item['image'], asset('assets/admin/img/160x160/img1.jpg'), 'product/') }}" alt="{{$review->item->name}} image">
                                            </a>
