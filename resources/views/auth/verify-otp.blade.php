...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/admin/css/theme.minc619.css?v=1.0')}}">
    ...
    <div class="auth-wrapper">
        <div class="auth-wrapper-left">
            <div class="auth-left-cont">
                ...
                src="{{\App\CentralLogics\Helpers::get_image_helper($store_logo,'value', asset('storage/business/').'/' . $store_logo->value, asset('//admin/img/favicon.png'),'business/')}}"  alt="public/img">
...
<!-- IE Support -->
<script>
    if (/MSIE \d|Trident.*rv:/.test(navigator.userAgent)) document.write('<script src="{{asset('/admin')}}/vendor/babel-polyfill/polyfill.min.js"><\/script>');
</script>
