                        ...
                        <div class="bg-light p-4 rounded mb-4">
                            <div class="px-xl-2 pb-sm-3">
                                        ...
                                        <div class="from-group">
                                            <label for="username" class="d-flex align-items-center gap-2 mb-2">
                                                ...
                                                <span class="cursor-pointer" data-bs-toggle="tooltip"
                                                      ...
                                                      <img src="{{asset('/installation')}}/assets/img/svg-icons/info2.svg" class="svg" alt="">
                                                </span>
                                            </label>
                                ...
                                <div class="d-flex gap-3 align-items-center mt-4">
                                    <img
                                        src="{{asset('/installation')}}/assets/img/svg-icons/php-version.svg"
                                        alt="">
                                    <div
                                        ...
                                        @if ($phpVersion >= 8.1)
                                            <img width="20"
                                                 src="{{asset('/installation')}}/assets/img/svg-icons/check.png"
                                                 alt="">
                                        @else
                                            <span class="cursor-pointer" data-bs-toggle="tooltip"
                                                  data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                                                  ...
                                                  data-bs-title="Your php version in server is lower than 8.1 version
                                                    ...
                                                    <img
                                                        src="{{asset('/installation')}}/assets/img/svg-icons/info.svg"
