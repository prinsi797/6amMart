        ...
        <div class="navbar-vertical-container">
            <div class="navbar-brand-wrapper justify-content-between">
                ...
                <a class="navbar-brand" href="{{route('vendor.dashboard')}}" aria-label="Front">
                    <img class="navbar-brand-logo initial--36  onerror-image"  data-onerror-image="{{asset('/admin/img/160x160/img2.jpg')}}"
                         src="{{\App\CentralLogics\Helpers::get_image_helper($store_data,'logo', asset('storage/store/').'/'.$store_data->logo, asset('/admin/img/160x160/img2.jpg'), 'store/') }}"
 alt="Logo">
                    <img class="navbar-brand-logo-mini initial--36 onerror-image"  data-onerror-image="{{asset('/admin/img/160x160/img2.jpg')}}"
                         src="{{\App\CentralLogics\Helpers::get_image_helper($store_data,'logo', asset('storage/store/').'/'.$store_data->logo, asset('/admin/img/160x160/img2.jpg'), 'store/') }}"
 alt="Logo">
                </a>
                <!-- End Logo -->
