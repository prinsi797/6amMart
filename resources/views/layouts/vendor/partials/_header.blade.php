                               ...
                               data-hs-unfold-options='{
                                ...
                                <div class="cmn--media right-dropdown-icon d-flex align-items-center">
                                    ...
                                    <div class="avatar avatar-sm avatar-circle">
                                        ...
                                        src="{{\App\CentralLogics\Helpers::get_image_helper(\App\CentralLogics\Helpers::get_loggedin_user(),'image', asset('storage/vendor/').'/'.\App\CentralLogics\Helpers::get_loggedin_user()->image, asset('assets/admin/img/160x160/img1.jpg'), 'vendor/') }}"
