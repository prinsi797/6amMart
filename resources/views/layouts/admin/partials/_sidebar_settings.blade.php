        ...
        <div class="navbar-vertical-container">
            <div class="navbar-brand-wrapper justify-content-between">
                ...
                <a class="navbar-brand" href="{{ route('admin.dispatch.dashboard') }}" aria-label="Front">
                    ...
                    src="{{\App\CentralLogics\Helpers::get_image_helper($store_logo,'value', asset('storage/business/').'/' . $store_logo->value, asset('assets/admin/img/160x160/img1.jpg') ,'business/' )}}"
                    alt="Logo">
                    ...
                    src="{{\App\CentralLogics\Helpers::get_image_helper($store_logo,'value', asset('storage/business/').'/' . $store_logo->value, asset('assets/admin/img/160x160/img2.jpg') ,'business/' )}}"
                    alt="Logo">
                </a>
                <!-- End Logo -->
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                @if(is_array(config('addon_admin_routes')) && count(config('addon_admin_routes')) > 0)
                    <li class="nav-item">
                        <small
                        ...
                        <a class="js-hs-unfold-invoker navbar-dropdown-account-wrapper" href="javascript:;"
                            ...
                            <div class="cmn--media right-dropdown-icon d-flex align-items-center">
                                <div class="avatar avatar-sm avatar-circle">
                                    ...
                                    src="{{\App\CentralLogics\Helpers::get_image_helper(auth('admin')->user(),'image', asset('storage/admin/').'/'.auth('admin')->user()->image, asset('assets/admin/img/160x160/img1.jpg') ,'admin/')}}"
