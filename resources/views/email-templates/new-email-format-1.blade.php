        ...
        <tbody>
            <tr>
                <td class="main-table-td">
                    ...
                    src="{{\App\CentralLogics\Helpers::get_image_helper( $data, 'image', asset('storage/email_template/').'/'.data_get($data, 'image'), asset('/admin/img/emai_demo_template_1.png'), 'email_template/') }}"
                    alt="image">
                    @if ($data?->button_url)
