    ...
    <table dir="{{ $site_direction }}" style="width:100%;max-width:500px;margin:0 auto;text-align:center;background:#fff">
        <tr>
            <td style="padding:30px 30px 0">
                ...
                src="{{\App\CentralLogics\Helpers::get_image_helper( $data, 'icon', asset('storage/email_template/').'/'.data_get($data, 'icon'), asset('/admin/img/emai_demo_template_2.png'), 'email_template/') }}"
                id="iconViewer" alt="">
        ...
        <tr>
            <td style="padding:0 30px 30px; text-align:start">
                ...
                <img style="width:100px;display:block;margin:10px auto"
                 src="{{\App\CentralLogics\Helpers::get_image_helper( $data, 'logo', asset('storage/email_template/').'/'.data_get($data, 'logo'), asset('/admin/img/emai_demo_template_2.png'), 'email_template/') }}"
                 alt="public/img">
                @else
                @php($store_logo = \App\Models\BusinessSetting::where(['key' => 'logo'])->first())
                <img style="width:100px;display:block;margin:10px auto" src="{{\App\CentralLogics\Helpers::get_image_helper($store_logo,'value', asset('storage/business/').'/' . $store_logo?->value, asset('/admin/img/160x160/img2.jpg') ,'business/')}}" alt="public/img">
                @endif
                <span class="privacy">
